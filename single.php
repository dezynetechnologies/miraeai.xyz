...
if (!empty($custom_page_layout && $use_custom_layout)) {
	...
	$layout = $masco['single_page_layout'];
} else {
...
?>
	<?php echo esc_html($mascoObj->masco_breadcrumb_bridge()); ?>
	<div class="content-block post-details-page">
		<div class="container">
			<div class="row justify-content-center">

				<?php if ('left-sidebar' == $layout &&  is_active_sidebar('masco_blog_sidebar')) : ?>
					<div class="col-lg-4 col-md-10 left-sidebar"><?php get_sidebar('masco_blog_sidebar'); ?></div>
				...
				<div class="col-lg-8 col-md-12">
					<main id="primary" class="site-main">
						...
						the_post_navigation(
							array(
								'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous post:', 'masco') . '</span> <span class="nav-title">' . $prev_icon . ' %title</span>',
								'next_text' => '<span class="nav-subtitle">' . esc_html__('Next post:', 'masco') . '</span> <span class="nav-title">%title ' . $next_icon . '</span>',
							)
						);
				...
				<?php if ('right-sidebar' == $layout && is_active_sidebar('masco_blog_sidebar')) : ?>
					<div class="col-lg-4 col-md-12 right-sidebar order-lg-1 order-0"><?php get_sidebar(); ?></div>
				<?php endif; ?>
			</div>
