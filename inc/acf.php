...
if (function_exists('acf_add_local_field_group')) :
    ...
    acf_add_local_field_group(array(
        ...
        'title' => esc_html__('Page Options', 'masco'),
        'fields' => array(
            array(
                'key' => 'field_5b5db8adfad44',
                'label' => esc_html__('General', 'masco'),
                'name' => '',
                'type' => 'tab',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                ...
                'label' => esc_html__('Body Background Color', 'masco'),
            ...
            array(
                ...
                'label' => esc_html__('Use Custom Logo', 'masco'),
            ...
            array(
                ...
                'label' => esc_html__('Select Logo', 'masco'),
                'name' => 'select_logo',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
    ...
    acf_add_local_field_group(array(
        ...
        'title' => esc_html__('Post Page Layout', 'masco'),
        'fields' => array(
            array(
                'key' => 'field_5b82b1e86dd24',
                'label' => esc_html__('Use Custom Page Layout?', 'masco'),
            ...
            array(
                ...
                'label' => esc_html__('Select Custom Layout', 'masco'),
    ...
    acf_add_local_field_group(array(
        ...
        'title' => esc_html__('Header Footer Include/Exclude Permission', 'masco') ,
        'fields' => array(
            array(
                'key' => 'field_600e8b3a91509',
                'label' => esc_html__('Include Rules', 'masco'),
                'name' => 'include_rules',
                'type' => 'repeater',
                'instructions' => '',
                'required' => 0,
                ...
                'sub_fields' => array(
                    array(
                        ...
                        'label' => esc_html__('Include On', 'masco'),
                        'name' => 'include_on',
                        'type' => 'select',
                        'instructions' => '',
                        'required' => 0,
            ...
            array(
                ...
                'label' => esc_html__('Exclude Rules', 'masco'),
                'name' => 'exclude_rules',
                'type' => 'repeater',
                'instructions' => '',
                'required' => 0,
                ...
                'sub_fields' => array(
                    array(
                        ...
                        'label' => esc_html__('Exclude On', 'masco'),
                        'name' => 'exclude_on',
                        'type' => 'select',
                        'instructions' => '',
                        'required' => 0,
