 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Masco for publication on ThemeForest
...
add_action( 'tgmpa_register', 'masco_register_required_plugins' );
 ...
 */
function masco_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => 'Masco Helper',
			'slug'      => 'masco-helper',
			'source'	=> get_parent_theme_file_path('/inc/plugins/plugin-files/masco-helper.zip'),
	 ...
	 */
	$config = array(
		'id'           => 'masco',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                      // Default absolute path to bundled plugins.
		'menu'         => 'masco-install-plugins', // Menu slug.
