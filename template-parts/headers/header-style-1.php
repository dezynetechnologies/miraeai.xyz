<?php
$has_site_logo =   (!empty(masco_get_site_logo())) ? 'has-site-logo' : '';
?>
<header class="masco-header-area header-style-1">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12">
                <div class="masco-header-wrap">
                    <div class="site-branding <?php echo esc_attr($has_site_logo)  ?>">
                        <a href="<?php echo esc_url(home_url()) ?>">
                            <?php
                            printf("%s", masco_get_site_logo());
                            ?>
                        </a>
                    </div><!-- .site-branding -->
                    <div class="masco-menu-wrap">
                        <div class="masco-main-menu-wrap navbar menu-style-inline justify-content-end">
                                    ...
                                    if (has_nav_menu('main-menu')) {
                                        wp_nav_menu(
                                            array(
                                                ...
                                                'menu_id' => 'navbar-nav',
                                                'container_class' => 'masco-menu-container'
                                            )
                                        );
                                    }
