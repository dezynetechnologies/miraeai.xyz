        ...
        <?php else : ?>
            ...
            <ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details">
                ...
                <li class="woocommerce-order-overview__order order">
                    ...
                    <strong><?php printf($order->get_order_number()); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                            ?></strong>
                </li>
                ...
                <?php if (is_user_logged_in() && $order->get_user_id() === get_current_user_id() && $order->get_billing_email()) : ?>
                    <li class="woocommerce-order-overview__email email">
                        ...
                        <strong><?php echo printf($order->get_billing_email()); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                                ?></strong>
                    </li>
                <?php endif; ?>
                ...
                <li class="woocommerce-order-overview__total total">
                    ...
                    <strong><?php echo printf($order->get_formatted_order_total()); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                            ?></strong>
                </li>
